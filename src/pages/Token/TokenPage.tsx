        ...
        !tokenData.exists ? (
          <LightGreyCard style={{ textAlign: 'center' }}>
            ...
            <StyledExternalLink
              ...
              href={`staging.swap.zircuit.com/#/add/${formattedAddress}`}
            >
              here.
            </StyledExternalLink>
          </LightGreyCard>
          ...
          <AutoColumn $gap="32px">
            <AutoColumn $gap="32px">
              ...
              <ResponsiveRow align="flex-end">
                ...
                {activeNetwork !== EthereumNetworkInfo ? null : (
                  <RowFixed>
                    <StyledExternalLink href={`staging.swap.zircuit.com/#/add/${formattedAddress}`}>
                    ...
                    <StyledExternalLink href={`staging.swap.zircuit.com/#/swap?inputCurrency=${formattedAddress}`}>
