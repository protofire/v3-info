        ...
        <AutoColumn $gap="32px">
          ...
          <ResponsiveRow align="flex-end">
            ...
            {activeNetwork !== ZIRCUIT_GARFIELD_TESTNETNetworkInfo ? null : (
              <RowFixed>
                <StyledExternalLink
                  href={`https://staging.zircuit-swap.w3us.site/#/add/${poolData.token0.address}/${poolData.token1.address}/${poolData.feeTier}`}
                >
                ...
                <StyledExternalLink
                  href={`https://staging.zircuit-swap.w3us.site/#/swap?inputCurrency=${poolData.token0.address}&outputCurrency=${poolData.token1.address}`}
                >
